...
//1.Завжди виписувати модифікатори (за винятком інтерфейсів)
//2.Назва Класів, назва перемінних, назва методів і тд повинні відповідати суті того чим вони являються
//  https://www.youtube.com/watch?v=I-8A16_DMqM&ab_channel=S0ER
//3.антипатерн "магическое число", виносити завжди в поля, ті що можуть мінятись - завжди зверху класу
//4.завжди провіряти вхідні значення в публічних методах/конструкторах
//5.забудь про строки, enum наше все
//6.представляй класи як сущності з реального життя, і що вони по факту можуть робити,
//  кошельож в реальному житті не може конвертувати валюти, він тільки її зберігає 
